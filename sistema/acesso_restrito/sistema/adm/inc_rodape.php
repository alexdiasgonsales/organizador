<?php ?>
  ...
  <tr>
   ...
   <font color="#999999">
     ...
     Rua Cel. Vicente, 281 – Centro – Porto Alegre - CEP 90.030-041 – Rio Grande do Sul – Brasil<br><br><br>
     <!-- 
     Desenvolvido por: <a href="mailto:crmachado@inf.ufrgs.br,crmbrrs@msn.com" style="font-family:Arial, Helvetica, sans-serif; font-size:10px; color:#999999; text-decoration:none;">Cleber Ramires Machado</a>
     -->
   </font>
   <br>
   <br>
