...
$html = "<html>
    ...
    while($linha = mysql_fetch_array($rs)){
        ...
        $html .= "<tr><td colspan=4><h2>Sessão ".$linha['id_sessao'].". Sala ".$linha['nome_sala'].". Dia ".$linha['data'].". Das ".
                    $linha['hora_ini']."h às ".$linha['hora_fim']."h</h2></td></tr>";
