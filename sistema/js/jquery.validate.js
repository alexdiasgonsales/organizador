//Necessita que antes seja carregado o arquivo constantes_URL.js

////var home = window.location.toString().toLowerCase();
//var n = home.indexOf("sistema/")+8;
//home = home.substr(0,n);  
//$('head').append('<script src="' + home + 'js/jquery.tablesorter.js" type="text/javascript"></script>');
try {
    $(function() {
        ...
        $('.validate').submit(function(e) {
            ...
            $(this).find('.required').each(function(i, elm) {
                ...
                if ($(this).hasClass('cpf')) {
                    ...
                    var cpf_array = ["111111111", "222222222", "333333333", "444444444", "555555555", "666666666", "777777777", "888888888", "999999999"];
