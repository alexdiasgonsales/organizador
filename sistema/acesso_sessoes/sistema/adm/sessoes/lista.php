...
<input type='checkbox' name='col_area' value='area' <?php if (isset($col_area)) echo " checked"; ?> >Área 
...
<input type='radio' name='ordenar' value='area' <?php if ($ordenar=='area') echo " checked"; ?> >Área 
...
<input type='radio' name='ordenar' value='sessao_agrupada' <?php if ($ordenar=='sessao_agrupada') echo " checked"; ?> >Sessão Agrupada<br /><br />
...
<br>
<input type="submit" value="Pesquisar" class="button blue" >
...
<input type="button" value="Imprimir" onclick="window.open('imprimir_sessoes.php?acao=imprimir','_blank')"  class="button blue"> <br /><br />
