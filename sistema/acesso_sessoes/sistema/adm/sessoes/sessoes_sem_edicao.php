...
<input type="button" value="Início" onclick="self.open('../home_restrito.php','_self')"  class="button red">
...
<?php 
  ...
  echo "<tr style='background: #CCDAB4'><td align='center' colspan='8' style='background: #CCDAB4'><h2>Sessões</h2></td></tr>";
  echo "<tr style='background: #CCDAB4'><td>&nbsp;<strong>ID:</strong></td><td>&nbsp;<strong>Num:</strong></td><td>&nbsp;<strong>Sala:</strong></td><td><strong>Mod.</strong></td><td>&nbsp;<strong>Data:</strong></td><td align=center><strong>Hora<br>Início</strong></td><td align=center><strong>Hora<br>Fim</strong></td><td align=center><strong>Qt.<br>Trabs.</strong></td><td align=center><strong>Qt.<br>Aval.</strong></td></tr>";
  ...
  echo "<a href='criar_sessao.php?acao=criar' class='button blue' style='margin-left:10px;font-size:12px;text-decoration:underline;'> Criar Sessão </a> <br> <br>";
