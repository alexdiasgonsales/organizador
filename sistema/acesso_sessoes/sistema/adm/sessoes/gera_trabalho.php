...
$array_tematica[0]  = " - ";
$array_tematica[1]  = "xCiências Exatas e da Terra";
$array_tematica[2]  = "xCiências Biológicas";
$array_tematica[3]  = "xEngenharias";
$array_tematica[4]  = "xCiências da Saúde";
$array_tematica[5]  = "xCiências Agrárias";
$array_tematica[6]  = "xCiências Sociais Aplicadas";
$array_tematica[7]  = "xCiências Humanas";
$array_tematica[8]  = "xLinguistica, Letras e Artes";
...
$var_html = "";
$var_html=$var_html."<div style='page-break-after: always; @charset: UTF-8;'>";
...
Trabalho aceito para apresentação na 15ª Mostra de Pesquisa, Ensino e Extensão<br>
Instituto Federal de Educação, Ciência e Tecnologia do Rio Grande do Sul<br>
Câmpus Porto Alegre<br>
15 e 16 setembro de 2014<br><br><br>
Trabalho Número: ".str_pad($id_trabalho, 3, "0", STR_PAD_LEFT).
"</td></tr></table>";
...
$var_html=$var_html."<tr><td align='left' bgcolor='#ffffff' style='font-size:16px;'>Apoiadores:&nbsp;".$linha['apoiadores']."<br><br></td></tr></table></div>";  
