...
if ($acao == "criar") {
  echo "<label style='margin-left:10px';>ID:</label><br><br><input id='id_sessao' name='id_sessao' type='text' value='".$id_sessao."' style='margin-left:10px;'><br><br>";
}
else {
    echo "<br><br><label style='margin-left:10px';>ID: ".$id_sessao."</label><br><br>";
...
<label style="margin-left:10px;">Numero:</label><br /><br />
...
<labelstyle="margin-left:10px;">Sala:</label><br /><br />
...
<input type="submit" value="Enviar Dados" class="button blue">

</form>

<a href="sessoes.php" class="button red">Sessões </a>
</div>
<?php
