...
<?php 
  ...
  echo "<tr><td align='center' colspan='11' style='background-color: #CCDAB4;'><h2>Sessões e Avaliadores</h2></td></tr>";
  echo "<tr style='background-color: #CCDAB4;'><td>&nbsp;<strong>ID</strong></td><td>&nbsp;<strong>Num</strong></td><td><strong>Sala</strong></td><td><strong>Mod.</strong></td><td>&nbsp;<strong>Data:</strong></td><td>&nbsp;<strong>Hora<br>Início</strong></td><td><strong>Hora<br>Fim</strong></td><td align=center>&nbsp;<strong>Avaliador<br>ID - Nome</strong></td><td colspan=3 align=center>Confirmação</td></tr>";
  while ($linha_sessao= mysql_fetch_array($result_sessao))
     {
       ...
       if ($linha_sessao['fk_avaliador'] > 0 ) {
        echo "<td>(".$linha_sessao['seq'].") ".$linha_sessao['fk_avaliador']." - ".$linha_sessao['nome_avaliador']."</td><td>".$array_confirmado[$linha_sessao['status']]."</td>";
		//echo "<td align='center'>&nbsp;<input type='button' value='Sim'  class='button blue' onclick='confirmar_avaliador(".$linha_sessao['id_sessao'].",".$linha_sessao['fk_avaliador'].")'></td><td align='center'>&nbsp;<input type='button' value='Não' class='button gray' onclick='desconfirmar_avaliador(".$linha_sessao['id_sessao'].",".$linha_sessao['fk_avaliador'].")'></td>";
		echo "</tr>";
       }
       else {
