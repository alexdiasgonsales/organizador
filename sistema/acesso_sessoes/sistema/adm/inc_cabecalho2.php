        ...
        <div id="conteudo"> 
            ...
            <div id="header">
                ...
                if (isset($_SESSION['nome_usuario']))
                   {
                     echo "<br /><br />&nbsp;&nbsp;<b>Você está logado como:</b>&nbsp;".$_SESSION['nome_usuario'].'<label class="lbl"><a href="#" onclick="logout(); return false;" class="button red">Sair</a></label><br><br>';   
                   } else if(isset($_SESSION['id_administracao'])) {
                        echo "<br /><br />&nbsp;&nbsp;<b>Você está logado como:</b>&nbsp;".$_SESSION['usuario'].'<label class="lbl"><a href="#" onclick="logout(); return false;" class="button red">Sair</a></label><br><br>';   
                   }    
                ?>
